...
class MODEL():
    ...
    def _create_variables(self, model_file):
        if not self.use_pretrain:
            ...
            param=pickle.load(open(model_file,'rb'))
    ...
    def _create_optimizer(self):
        self.optimizer = tf.train.AdamOptimizer(
                learning_rate=self.learning_rate,name='dis_adam').minimize(self.loss)
